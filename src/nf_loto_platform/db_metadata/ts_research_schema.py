...
This module defines the SQL used to create the logical schema described in
the TimeSeriesScientist extension design. Keeping it in Python allows tests,
migrations and ad‑hoc setup scripts to share the same source of truth.
"""

from __future__ import annotations

TS_RESEARCH_SCHEMA = "ts_research"
...
def get_ts_research_ddl() -> str:
    """Return the SQL DDL for creating the ts_research schema and tables."""
    return TS_RESEARCH_DDL
